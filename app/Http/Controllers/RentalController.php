...
class RentalController extends Controller
{
    ...
    public function rental(Request $request, $id)
    {
        ...
        //cek validasi
        $cek_pesanan = Pesanan::where('user_id', Auth::user()->id)->where('status_pembayaran',0)->first();
        ...
        $pesanan_baru = Pesanan::where('user_id', Auth::user()->id)->where('status_pembayaran',0)->first();
