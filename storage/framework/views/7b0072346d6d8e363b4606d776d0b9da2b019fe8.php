        ...
        <div class="col-md-2">
            <ul class="list-group list-group-flush fixed">
                ...
                <li class="list-group-item">
                    <a href="<?php echo e(route('brand.kategori', $item->slug)); ?>" class="link"><?php echo e($item->nama_brand); ?></a>
                </li>
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\campzone-master2\resources\views//client/produk.blade.php ENDPATH**/ ?>