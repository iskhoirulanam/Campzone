    ...
    <div class="col-md-6">
        <form action="/admin/produk/insert-produk" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="merek" required="required" class="form-control" placeholder="Nama Produk">
            </div>
            <div class="form-group">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\campzone-master\resources\views/admin/produk/tambah_produk.blade.php ENDPATH**/ ?>